...
/*  2 */ _CFFI_OP(_CFFI_OP_FUNCTION, 15), // struct Node *()(struct Person *)
/*  3 */ _CFFI_OP(_CFFI_OP_POINTER, 23), // struct Person *
/*  4 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/*  5 */ _CFFI_OP(_CFFI_OP_FUNCTION, 3), // struct Person *()(void)
/*  6 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/*  7 */ _CFFI_OP(_CFFI_OP_FUNCTION, 25), // void()(struct LinkedList *)
/*  8 */ _CFFI_OP(_CFFI_OP_POINTER, 21), // struct LinkedList *
/*  9 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 10 */ _CFFI_OP(_CFFI_OP_FUNCTION, 25), // void()(struct LinkedList *, struct Person *)
/* 11 */ _CFFI_OP(_CFFI_OP_NOOP, 8),
/* 12 */ _CFFI_OP(_CFFI_OP_NOOP, 3),
/* 13 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 14 */ _CFFI_OP(_CFFI_OP_FUNCTION, 25), // void()(struct Node *)
/* 15 */ _CFFI_OP(_CFFI_OP_POINTER, 22), // struct Node *
/* 16 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 17 */ _CFFI_OP(_CFFI_OP_FUNCTION, 25), // void()(void)
/* 18 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 19 */ _CFFI_OP(_CFFI_OP_POINTER, 20), // char const *
/* 20 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 2), // char
/* 21 */ _CFFI_OP(_CFFI_OP_STRUCT_UNION, 0), // struct LinkedList
/* 22 */ _CFFI_OP(_CFFI_OP_STRUCT_UNION, 1), // struct Node
/* 23 */ _CFFI_OP(_CFFI_OP_STRUCT_UNION, 2), // struct Person
...
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_appendList(PyObject *self, PyObject *args)
{
  ...
  if (!PyArg_UnpackTuple(args, "appendList", 2, 2, &arg0, &arg1))
    return NULL;
...
#else
#  define _cffi_f_appendList _cffi_d_appendList
#endif

static struct LinkedList * _cffi_d_createList(void)
{
  return createList();
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_createList(PyObject *self, PyObject *noarg)
{
...
#else
#  define _cffi_f_createList _cffi_d_createList
#endif

static struct Node * _cffi_d_createNode(struct Person * x0)
{
  return createNode(x0);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_createNode(PyObject *self, PyObject *arg0)
{
  struct Person * x0;
  Py_ssize_t datasize;
  struct _cffi_freeme_s *large_args_free = NULL;
  ...
  if (datasize != 0) {
    x0 = ((size_t)datasize) <= 640 ? (struct Person *)alloca((size_t)datasize) : NULL;
...
static void _cffi_d_freeNode(struct Node * x0)
{
  freeNode(x0);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_freeNode(PyObject *self, PyObject *arg0)
{
  struct Node * x0;
  Py_ssize_t datasize;
  struct _cffi_freeme_s *large_args_free = NULL;
...
#else
#  define _cffi_f_freeNode _cffi_d_freeNode
#endif
...
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_getPerson(PyObject *self, PyObject *noarg)
{
...
#else
#  define _cffi_f_getPerson _cffi_d_getPerson
#endif

static void _cffi_d_initialise(void)
{
  initialise();
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_initialise(PyObject *self, PyObject *noarg)
{
...
static void _cffi_checkfld_struct_LinkedList(struct LinkedList *p)
{
  ...
  (void)p;
  { struct Node * *tmp = &p->head; (void)tmp; }
}
struct _cffi_align_struct_LinkedList { char x; struct LinkedList y; };
...
static void _cffi_checkfld_struct_Node(struct Node *p)
{
  /* only to generate compile-time warnings or errors */
  (void)p;
  { struct Person * *tmp = &p->data; (void)tmp; }
  { struct Node * *tmp = &p->next; (void)tmp; }
}
struct _cffi_align_struct_Node { char x; struct Node y; };

_CFFI_UNUSED_FN
static void _cffi_checkfld_struct_Person(struct Person *p)
{
  /* only to generate compile-time warnings or errors */
  (void)p;
  { char const * *tmp = &p->name; (void)tmp; }
  (void)((p->age) | 0);  /* check that 'struct Person.age' is an integer */
}
...
static const struct _cffi_global_s _cffi_globals[] = {
  ...
  { "freeNode", (void *)_cffi_f_freeNode, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_O, 14), (void *)_cffi_d_freeNode },
  { "getPerson", (void *)_cffi_f_getPerson, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_N, 5), (void *)_cffi_d_getPerson },
  { "initialise", (void *)_cffi_f_initialise, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_N, 17), (void *)_cffi_d_initialise },
...
static const struct _cffi_struct_union_s _cffi_struct_unions[] = {
  { "LinkedList", 21, _CFFI_F_CHECK_FIELDS,
  ...
  { "Person", 23, _CFFI_F_CHECK_FIELDS,
